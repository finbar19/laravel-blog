...
<head>
  ...
  <!-- Font Awesome -->
  <link rel="stylesheet" href="{{URL::asset('backend/plugins/font-awesome/css/font-awesome.min.css')}}">
  <!-- Ionicons -->
  ...
  <link rel="stylesheet" href="{{URL::asset('backend/plugins/simplemde/simplemde.min.css')}}">
...
<!-- jQuery 2.2.3 -->
<script src="{{URL::asset('backend/js/jquery-2.2.3.min.js')}}"></script>
<!-- Bootstrap 3.3.6 -->
<script src="{{URL::asset('backend/js/bootstrap.min.js')}}"></script>
<script src="{{URL::asset('backend/plugins/simplemde/simplemde.min.js')}}"></script>
